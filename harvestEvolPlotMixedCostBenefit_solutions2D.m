function [Vrange,Ssols_stable,Ssols_unstable,yMax]=harvestEvolPlotMixedCostBenefit_solutions2D(initV,rates,cycleFreq,endTimes,Ds,DDVs,DV,CV,params)
...
% text(1,1.9,{['\beta=' num2str(bet) ', \rho=' num2str(p) ', \alpha=' num2str(alph)];
%     ['u_E=' num2str(-Cf) ', u_S=' num2str(Vs) ', u_{ES}=' num2str(Ves)];
%     },'FontSize',16);
